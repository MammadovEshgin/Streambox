...
export const personaCardImages = {
  male: {
    ...
    dramaDevotee: require("../../assets/images/personas/male/The drama devotee-male.jpg"),
  ...
  female: {
    ...
    dramaDevotee: require("../../assets/images/personas/female/The drama devotee-female.jpg"),
