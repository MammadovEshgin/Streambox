...
const desiredOrder = [
  ...
  { slug: "harry-potter-collection", sortOrder: 3 },
  { slug: "middle-earth-collection", sortOrder: 4 },
  { slug: "star-wars-collection", sortOrder: 5 },
  { slug: "james-bond-collection", sortOrder: 6 },
  { slug: "mission-impossible-collection", sortOrder: 7 },
  { slug: "the-fast-and-the-furious-collection", sortOrder: 8 },
  { slug: "the-bourne-collection", sortOrder: 9 },
  { slug: "john-wick-collection", sortOrder: 10 },
  { slug: "dune-collection", sortOrder: 11 },
  { slug: "the-hunger-games-collection", sortOrder: 12 },
  { slug: "indiana-jones-collection", sortOrder: 13 },
  { slug: "saw-collection", sortOrder: 14 },
  { slug: "scream-collection", sortOrder: 15 },
  { slug: "the-conjuring-collection", sortOrder: 16 },
  { slug: "insidious-collection", sortOrder: 17 },
];
